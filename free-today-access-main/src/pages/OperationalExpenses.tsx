...
export default function OperationalExpenses() {
  ...
  const cats = (categories || []).filter(c => c.group === 'Operacional');
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" style={{ fontFamily: 'Nunito' }}>Despesas Operacionais</h1>
          <p className="text-sm text-muted-foreground">Ingredientes, gás, manutenção e compras</p>
        </div>
