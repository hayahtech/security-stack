...
const mockHistory = [
  { month: "Abr/23", orcado: 11000, gasto: 11200 },
  { month: "Mai/23", orcado: 11000, gasto: 10800 },
  { month: "Jun/23", orcado: 11500, gasto: 12300 },
  { month: "Jul/23", orcado: 11500, gasto: 11100 },
  { month: "Ago/23", orcado: 11500, gasto: 11900 },
  { month: "Set/23", orcado: 12000, gasto: 12400 },
  { month: "Out/23", orcado: 12000, gasto: 11700 },
  { month: "Nov/23", orcado: 12000, gasto: 13100 },
  { month: "Dez/23", orcado: 12500, gasto: 15200 },
  { month: "Jan/24", orcado: 12000, gasto: 11800 },
  { month: "Fev/24", orcado: 12000, gasto: 12100 },
  { month: "Mar/24", orcado: 12000, gasto: 11900 },
  { month: "Abr/24", orcado: 12200, gasto: 12400 },
  { month: "Mai/24", orcado: 12200, gasto: 12000 },
  { month: "Jun/24", orcado: 12500, gasto: 12800 },
  { month: "Jul/24", orcado: 12500, gasto: 12200 },
  { month: "Ago/24", orcado: 12500, gasto: 12900 },
  { month: "Set/24", orcado: 12700, gasto: 12500 },
  { month: "Out/24", orcado: 12700, gasto: 13100 },
  { month: "Nov/24", orcado: 12700, gasto: 13400 },
  { month: "Dez/24", orcado: 13000, gasto: 15800 },
  { month: "Jan/25", orcado: 13000, gasto: 12500 },
  { month: "Fev/25", orcado: 13000, gasto: 12800 },
  { month: "Mar/25", orcado: 13000, gasto: 12900 },
  { month: "Abr/25", orcado: 13200, gasto: 13100 },
  { month: "Mai/25", orcado: 13200, gasto: 12700 },
  { month: "Jun/25", orcado: 13200, gasto: 13400 },
  { month: "Jul/25", orcado: 13000, gasto: 12800 },
  { month: "Ago/25", orcado: 13000, gasto: 13200 },
  { month: "Set/25", orcado: 13200, gasto: 13000 },
...
export default function OrcamentoFamiliar() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle className="text-base">Insights & Recomendações</CardTitle></CardHeader>
        <CardContent className="space-y-3">
          <div className="flex gap-3 p-3 rounded-lg bg-blue-500/10 border border-blue-200/30">
            <div className="text-2xl shrink-0">📊</div>
            <div className="min-w-0">
              <p className="font-medium text-sm text-foreground">Gastos consistentes</p>
              <p className="text-xs text-muted-foreground mt-0.5">Sua variação mensal está controlada (±8% do orçado)</p>
            </div>
          </div>
          <div className="flex gap-3 p-3 rounded-lg bg-amber-500/10 border border-amber-200/30">
            <div className="text-2xl shrink-0">💡</div>
            <div className="min-w-0">
              <p className="font-medium text-sm text-foreground">Oportunidade de economia</p>
              <p className="text-xs text-muted-foreground mt-0.5">Reduzindo "Restaurantes" em 15% economizaria R$ {fmt(categories.find(c => c.name === "Restaurantes")?.budgeted ? (categories.find(c => c.name === "Restaurantes")?.budgeted || 0) * 0.15 : 120)}/mês</p>
            </div>
          </div>
          <div className="flex gap-3 p-3 rounded-lg bg-green-500/10 border border-green-200/30">
            <div className="text-2xl shrink-0">🎯</div>
            <div className="min-w-0">
              <p className="font-medium text-sm text-foreground">Meta atingida</p>
              <p className="text-xs text-muted-foreground mt-0.5">Sua poupança já atingiu {fmt(categories.filter(c => c.block === "poupanca").reduce((s, c) => s + c.spent, 0))} dos {fmt(categories.filter(c => c.block === "poupanca").reduce((s, c) => s + c.budgeted, 0))} planejados</p>
            </div>
          </div>
        </CardContent>
      </Card>
