...
// -------- Regex --------
// Caracteres válidos no corpo (12 primeiras posições): A-Z e 0-9 (sem cedilha/acentos)
const CNPJ_BODY_REGEX = /^[A-Z0-9]{12}[0-9]{2}$/;
// Caracteres para limpeza de máscara (mantém só A-Z e 0-9)
const CLEAN_REGEX = /[^A-Z0-9]/g;
// Sequência totalmente repetida (ex.: 00000000000000, AAAAAAAAAAAAAA)
const ALL_SAME_REGEX = /^(.)\1{13}$/;

// Pesos do módulo 11, da direita para a esquerda: 2..9, reiniciando
...
/**
 * Converte caractere para seu valor numérico conforme regra ASCII - 48.
 * '0'..'9' => 0..9  |  'A'..'Z' => 17..42
 */
...
/**
 * Calcula um dígito verificador a partir dos caracteres e pesos informados.
 */
 ...
 * Use esta função como único ponto de entrada antes de persistir no banco.
 */
